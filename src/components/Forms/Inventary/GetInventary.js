        ...
        try {
            if(item.publico === 'hombre'){
                const qrDataUrl34 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+34, { errorCorrectionLevel: 'H' });
                    ...
                    const qrDataUrl37 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+item.publico+'/'+37, { errorCorrectionLevel: 'H' });
                    ...
                    const qrDataUrl38 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+item.publico+'/'+38, { errorCorrectionLevel: 'H' });
                    ...
                    const qrDataUrl40 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+40, { errorCorrectionLevel: 'H' });
                    ...
                    const qrDataUrl41 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+41, { errorCorrectionLevel: 'H' });
                    ...
                    doc.text(`${item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+item.publico+'/'}41`,
                        ...
                        const qrDataUrl42 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+42, { errorCorrectionLevel: 'H' });
                    ...
                    const qrDataUrl43 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+43, { errorCorrectionLevel: 'H' });
                    doc.rect(10, 20, 180, 20);
            ...
            if(item.publico === 'mujer' ){
                const qrDataUrl34 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+34, { errorCorrectionLevel: 'H' });
                    ...
                    doc.text(`${item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+item.publico+'/'}40`,
                        ...
                        const qrDataUrl42 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+41, { errorCorrectionLevel: 'H' });
            ...
            if(item.publico === 'niña'){
                const qrDataUrl21 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+21, { errorCorrectionLevel: 'H' });
                    doc.rect(10, 20, 180, 20);
                    ...
                    const qrDataUrl22 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+22, { errorCorrectionLevel: 'H' });
                    doc.rect(10, 50, 180, 20);
                    ...
                    const qrDataUrl23 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+23, { errorCorrectionLevel: 'H' });
                    doc.rect(10, 80, 180, 20); 
                    ...
                    const qrDataUrl24 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+item.publico+'/'+24, { errorCorrectionLevel: 'H' });
                    doc.rect(10, 110, 180, 20); 
                    ...
                    const qrDataUrl25 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+item.publico+'/'+25, { errorCorrectionLevel: 'H' });
                    doc.rect(10, 140, 180, 20); 
                    ...
                    doc.rect(10, 170, 180, 20); 
                    const qrDataUrl26 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+'/'+26, { errorCorrectionLevel: 'H' });
                    ...
                    const qrDataUrl27 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+27, { errorCorrectionLevel: 'H' });
                    ...
                    const qrDataUrl28 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+28, { errorCorrectionLevel: 'H' });
                    ...
                    doc.text(`${item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+item.publico+'/'}28`,
                        ...
                        const qrDataUrl29 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+29, { errorCorrectionLevel: 'H' });
                    ...
                    const qrDataUrl30 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+30, { errorCorrectionLevel: 'H' });
                    doc.rect(10, 20, 180, 20);
                    ...
                    const qrDataUrl31 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+31, { errorCorrectionLevel: 'H' });
                    doc.rect(10, 50, 180, 20);
                    ...
                    const qrDataUrl32 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+32, { errorCorrectionLevel: 'H' });
                    doc.rect(10, 80, 180, 20); 
                    ...
                    const qrDataUrl33 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+item.publico+'/'+33, { errorCorrectionLevel: 'H' });
                    doc.rect(10, 110, 180, 20); 
                    ...
                    const qrDataUrl34 = await QRCode.toDataURL(item.empresa+'/'+item.referencia+'/'+item.color+'/'+item.lugar+'/'+item.publico+'/'+34, { errorCorrectionLevel: 'H' });
                    doc.rect(10, 140, 180, 20); 
