                        ...
                        <TableBody>
                            {ventas.map((item) => (
                                <TableRow key={item.idventas}>
                                    ...
                                    <TableCell sx={{ color: 'white' }}>{item.fk_idusuarios}</TableCell>
                                    <TableCell sx={{ color: 'white' }}>{item.fk_referencia}</TableCell>
                                    <TableCell sx={{ color: 'white' }}>{item.estado ? 'Activo' : 'Inactivo'}</TableCell>
                                    <TableCell sx={{ color: 'white' }}>{new Date(item.fecha).toLocaleString()}</TableCell>
