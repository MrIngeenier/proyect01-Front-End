...
import GetInventaryCasher from '../../Forms/Inventary/GetInventaryCasher';
import GetVentasCasher from '../../Forms/Sales/GetVentasCasher';
...
export default function CasherDashboard() {
  ...
  const handleInventariosClick = () => {
    ...
    setTitle("INVENTARIO");
    setActiveComponent(() => GetInventaryCasher);
  };

  const handleVentasClick = () => {
    //console.log('Botón Herramientas presionado');
    setTitle("VENTAS");
    setActiveComponent(() => GetVentasCasher);
